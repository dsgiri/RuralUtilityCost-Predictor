...
export function SectionExplanation() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 border-t border-slate-200 pt-16">
      <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100">
        <h3 className="text-xl font-bold tracking-tight text-slate-900 mb-4">How predictions work</h3>
      ...
      <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100">
        <h3 className="text-xl font-bold tracking-tight text-slate-900 mb-4">Limits and assumptions</h3>
        <ul className="space-y-3 text-sm text-slate-600">
          <li className="flex items-start">
